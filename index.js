...
const developers = "834473980579545088"//الايدي حقك
const activities = [
  "-help || by Reqping9#6013",
  "-help || by Reqping9#6013",
  "-help || by Reqping9#6013",
  "-help || by Reqping9#6013"
];
...
client.on("message", async message => {
  ...
  if(message.author.id === client.user.id) return;
    ...
    message.channel.send("https://media.discordapp.net/attachments/911725253057732629/915710532823187496/1638097184327.png");
...
msg.delete();        msg.channel.send("https://media.discordapp.net/attachments/911725253057732629/915710532823187496/1638097184327.png")
    }
});
...
client.on('message', badboy => {
  if(badboy.content.startsWith(prefix + "fedback")){
    ...
    var fedbackchannel = badboy.guild.channels.cache.find(channel => channel.name === "〢❖・آراء"); //اسم الروم
...
client.on('message', badboy => {
  if(badboy.content.startsWith(prefix + "sug")){
    ...
    var fedbackchannel = badboy.guild.channels.cache.find(channel => channel.name === "〢❖・إقتراحات"); //اسم الروم
