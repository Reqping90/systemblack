...
const app = express();
http.createServer(function (req, res) { res.write("im the bot system of blacklife"); res.end(); }).listen(8080);
...
const youtube = new YouTube("AIzaSyC6NdDKtuyHyzF75dslrCMjYmPRuChODS0"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyC6NdDKtuyHyzF75dslrCMjYmPRuChODS0"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@834473980579545088>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
